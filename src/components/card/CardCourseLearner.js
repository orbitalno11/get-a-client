                    ...
                    <Fragment>
                        <Row align="middle" justify={"space-between"}>
                            ...
                            <Col span={16} align="start" style={{paddingLeft:'1rem'}}>
                                <span className={`${styles.titleH5} ${styles.textOneLine}`}>{data && data.fullNameText}</span>
                    ...
                    : (<Fragment>
                        <Row align="center" >
                            ...
                            <Col span={24} align="center">
                                <span className={`${styles.titleH4} ${styles.textOneLine}`}>{data && data.fullNameText}</span>
                            </Col>
