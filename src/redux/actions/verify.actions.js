...
function getIdentityVerifyList() {
    return dispatch => {
        ...
        apiURL.apiGetA.get("/verify/identities").then(res => {
...
function geteEducationVerifyList() {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get("/verify/educations").then(res => {
            dispatch(loadingActions.stopLoading())
            const verify = res.data.data
            dispatch(success(verify))
        }).catch(err => {
...
function geteTestVerifyList() {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get("/verify/testings").then(res => {
            dispatch(loadingActions.stopLoading())
            const verify = res.data.data
            dispatch(success(verify))
        }).catch(err => {
...
function geteProfileDetail(id) {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get(`/verify/identity/${id}`)
            .then(res => {
                dispatch(loadingActions.stopLoading())
                const verify = res.data.data
                dispatch(success(verify))
...
function geteEducationDetail(id) {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get(`/verify/education/${id}`)
            .then(res => {
                dispatch(loadingActions.stopLoading())
                const verify = res.data.data
                dispatch(success(verify))
...
function geteTestingDetail(id) {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get(`/verify/testing/${id}`)
            .then(res => {
                dispatch(loadingActions.stopLoading())
                const verify = res.data.data
                dispatch(success(verify))
...
function geteManageIdentity(requestId, approved) {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get("/verify/identity", {
            params: {
                id: requestId,
                approved: approved
            }
...
function geteManageEducation(requestId, approved) {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get("/verify/education", {
            params: {
                id: requestId,
                approved: approved
            }
...
function geteManageTesting(requestId, approved) {
    return dispatch => {
        dispatch(loadingActions.startLoading())
        apiURL.apiGetA.get("/verify/testing", {
            params: {
                id: requestId,
                approved: approved
            }
